...
The `.temp/leansweden/source/generate_data.py` script is a reproducible integration fixture for LEAN's custom-market data paths. It uses QRT for synthetic prices and exchange sessions, then writes native LEAN files.
